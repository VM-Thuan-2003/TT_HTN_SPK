...
class App:
    def __init__(self, root):
        ...
        self.controller = BluetoothController("B8:27:EB:0E:F2:0D", 1)  # Thay đổi địa chỉ MAC và cổng theo yêu cầu
        ...
        self.send_button = ttk.Button(root, text="Send Command", command=self.send_command_entry, state=tk.DISABLED)
    ...
    def led_inv(self):
        self.send_command("led_inv")
    def info(self):
        label_1 = ttk.Label(self.root, foreground="red", text = "Bài tập: Ứng dụng điều khiển led có đảo chiều")
        ...
        label_3 = ttk.Label(self.root, text = "Thành viên 1: Võ Minh Thuận - MSSV: 21161366")
        label_3.place(x=50,y=300)
        label_4 = ttk.Label(self.root, text = "Thành viên 2: Lê Quang Thương - MSSV: 21161363")
        label_4.place(x=50,y=320)
        label_5 = ttk.Label(self.root, text = "Thành viên 3: Trần Thị Xuân Hy - MSSV: 21161323")
        label_5.place(x=50,y=340)

    def layout_main(self):
        B11 = ttk.Button(self.root, text="LED 1 ON ", width=20, command=self.led_1_on)
        B11.place(x=50, y=100)
        B12 = ttk.Button(self.root, text="LED 1 OFF", width=20, command=self.led_1_off)
        B12.place(x=250, y=100)

        B21 = ttk.Button(self.root, text="LED 2 ON ", width=20, command=self.led_2_on)
        B21.place(x=50, y=150)
        B22 = ttk.Button(self.root, text="LED 2 OFF", width=20, command=self.led_2_off)
